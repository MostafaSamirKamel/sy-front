      ...
      <div className="space-y-4 pb-2">
        ...
        <Section title={t('adminCaseSectionPatient')}>
          <div className="grid sm:grid-cols-2 gap-3">
            ...
            <input className="input-field" placeholder="Birth place" value={form.patientBirthPlace} onChange={(e) => setForm({ ...form, patientBirthPlace: e.target.value })} />
            <input className="input-field" placeholder="Residence" value={form.patientResidence} onChange={(e) => setForm({ ...form, patientResidence: e.target.value })} />
            <input className="input-field" placeholder="Occupation" value={form.patientOccupation} onChange={(e) => setForm({ ...form, patientOccupation: e.target.value })} />
            <input className="input-field" placeholder="Marital status" value={form.patientMaritalStatus} onChange={(e) => setForm({ ...form, patientMaritalStatus: e.target.value })} />
            <input className="input-field" placeholder="Smoking status" value={form.patientSmokingStatus} onChange={(e) => setForm({ ...form, patientSmokingStatus: e.target.value })} />
            <input className="input-field" placeholder="Alcohol status" value={form.patientAlcoholStatus} onChange={(e) => setForm({ ...form, patientAlcoholStatus: e.target.value })} />
