...
STAGE = ROOT / "deploy" / "_qbank_import_stage"
TAR = ROOT / "deploy" / "_qbank_import_hotfix.tar.gz"
...
remote = "/tmp/_qbank_import_hotfix.tar.gz"
...
grep -n 'questionHeaders' {APP}/server/dist/lib/qbankStructuredImportParser.js | head -3
"""
print(">>> deploying")
